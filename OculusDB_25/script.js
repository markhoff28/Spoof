...
headsets = [{"headset":1,"codename":"MONTEREY","displayName":"Quest 1","binaryType":1,"group":0,"groupString":"Quest","info":""},{"headset":2,"codename":"HOLLYWOOD","displayName":"Quest 2","binaryType":1,"group":0,"groupString":"Quest","info":""},{"headset":7,"codename":"EUREKA","displayName":"Quest 3","binaryType":1,"group":0,"groupString":"Quest","info":""},{"headset":6,"codename":"SEACLIFF","displayName":"Quest Pro","binaryType":1,"group":0,"groupString":"Quest","info":""},{"headset":8,"codename":"PANTHER","displayName":"Quest 3S","binaryType":1,"group":0,"groupString":"Quest","info":""},{"headset":0,"codename":"RIFT","displayName":"Rift","binaryType":2,"group":1,"groupString":"PCVR","info":"Link compatible"},{"headset":5,"codename":"LAGUNA","displayName":"Rift S","binaryType":2,"group":1,"groupString":"PCVR","info":"Link compatible"},{"headset":4,"codename":"PACIFIC","displayName":"Go","binaryType":1,"group":2,"groupString":"GoAndGearVr","info":""},{"headset":3,"codename":"GEARVR","displayName":"GearVR","binaryType":1,"group":2,"groupString":"GoAndGearVr","info":""},{"headset":9,"codename":"FUTURE_DEVICES","displayName":"Future devices","binaryType":1,"group":0,"groupString":"Quest","info":""}]
...
<div id="navBarContent" class="navBarInnerRight anim">
    ...
    <a class="underlineAnimation navBarElement" style="height: 100%;" href="https://discord.gg/zwRfHQN2UY"><img alt="Discord logo" style="height: 100%;" src="/assets/discord.svg"></a>
</div>
</div>
<div class="footer">
    ...
    <div class="info">
        ...
        <div class="${expanded ? ``: `hidden`}" id="${htmlId}">
            <table>
                ...
                <tr><td class="label">Installed Size</td><td class="value">${application.total_installed_space < 0 ? "Unknown" :application.totalInstalledSpaceFormatted}</td></tr>
                <tr><td class="label">Space required</td><td class="value">${application.required_space_adjusted < 0 ? "Unknown" : application.requiredSpaceAdjustedFormatted}</td></tr>
...
function GetHelp() {
    ...
    <br/>
    <br/>
    In case you still need help, here's the link to the <a href="https://discord.gg/zwRfHQN2UY">OculusDB Discord</a>
    `);
}
    ...
    fetch(`/api/v1/id/${data.parentId}`).then(res => res.json().then(res => {
        ...
        PopUp(`
            <div>
                ...
                <br>
                Need help? Join <a href="https://discord.gg/zwRfHQN2UY">The OculusDB Discord server</a>
                <br>
                <div>
                    <input type="button" value="OK" onmousedown="MouseDown(event)" onmouseup="if(MouseUp(event)) { ClosePopUp(); }">
                </div>
